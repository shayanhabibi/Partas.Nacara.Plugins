...
module Menu =
    ...
    /// <see cref="T:Partas.Nacara.Theme.Badge" /> holds the ones it has colours for.</param>
...
type ThemeOptions =
    {
        ...
        Css: string list
        /// <summary>The parts the theme's stylesheet is built from, in cascade order.</summary>
        /// <remarks>
        /// The theme's own seven to begin with. Change them with
        /// <see cref="M:Partas.Nacara.Theme.Theme.replaceLayer" />,
        /// <see cref="M:Partas.Nacara.Theme.Theme.dropLayer" /> and
        /// <see cref="M:Partas.Nacara.Theme.Theme.layerAfter" /> rather than by hand, so a layer that is
